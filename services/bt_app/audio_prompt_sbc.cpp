...
#define DEFAULT_COEFF_FOR_MIX_PROMPT_FOR_MUSIC      0.4//1.0
#define DEFAULT_COEFF_FOR_MIX_MUSIC_FOR_MUSIC       0.2//0.8//0.4
#define DEFAULT_COEFF_FOR_MIX_PROMPT_FOR_CALL       0.4//1.0
#define DEFAULT_COEFF_FOR_MIX_CALL_FOR_CALL         0.2//0.8//0.4
...
bool audio_prompt_start_playing(uint16_t promptPram, uint32_t targetSampleRate)
{
    ...
    audio_prompt_env.mergeInOverlapLength = DEFAULT_OVERLAP_LENGTH * audio_prompt_env.targetChannelCnt;
    audio_prompt_env.mergeOutOverlapLength = DEFAULT_OVERLAP_LENGTH * audio_prompt_env.targetChannelCnt;
    audio_prompt_env.mergeInWeight = 0.f;
    audio_prompt_env.mergeOutWeight = 1.f;
    audio_prompt_env.mergeStep = 1.f / (DEFAULT_OVERLAP_LENGTH - 1);
