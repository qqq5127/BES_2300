...
#include "reg_iomuxip_fpga1000.h"
#include "hal_iomuxip_fpga1000.h"
#include "reg_cmu_fpga1000.h"
#include "hal_cmu.h"
#include "hal_iomux.h"
#include "hal_uart.h"
#include "hal_trace.h"
...
static const struct pin_function_regbit_map _pfr_map[HAL_IOMUX_PIN_NUM][HAL_IOMUX_MAP_NUM+1] = {
    ...
    /* 1 0 */ {
                {HAL_IOMUX_FUNC_I2S0_WS, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S1_GPIO_EN_MASK},
    ...
    /* 1 1 */ {
                {HAL_IOMUX_FUNC_I2S0_SDI0, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S1_GPIO_EN_MASK},
    ...
    /* 1 2 */ {
                {HAL_IOMUX_FUNC_I2S0_SDO, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S1_GPIO_EN_MASK},
                {HAL_IOMUX_FUNC_PDM0_D, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_MIC_DIG_EN_MASK},
                {HAL_IOMUX_FUNC_END, 0, 0},
              },
    /* 1 3 */ {
                {HAL_IOMUX_FUNC_I2S0_SCK, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S1_GPIO_EN_MASK},
    ...
    /* 1 4 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_WS, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S2_GPIO_EN_MASK},
                /* TODO agpio 0 */
    ...
    /* 1 5 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SDI0, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S2_GPIO_EN_MASK},
                /* TODO agpio 1 */
    ...
    /* 1 6 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SDO, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S2_GPIO_EN_MASK},
                /* TODO agpio 2 */
    ...
    /* 1 7 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SCK, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S2_GPIO_EN_MASK},
                /* TODO agpio 3 */
    ...
    /* 2 2 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_WS, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S3_GPIO_EN_MASK},
                {HAL_IOMUX_FUNC_END, 0, 0},
              },
    /* 2 3 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SDI0, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S3_GPIO_EN_MASK},
                {HAL_IOMUX_FUNC_END, 0, 0},
              },
    /* 2 4 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SDO, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S3_GPIO_EN_MASK},
                {HAL_IOMUX_FUNC_END, 0, 0},
              },
    /* 2 5 */ {
                ...
                {HAL_IOMUX_FUNC_I2S0_SCK, IOMUXIP_MUX04_REG_OFFSET, IOMUXIP_MUX04_I2S3_GPIO_EN_MASK},
                {HAL_IOMUX_FUNC_END, 0, 0},
              },
    /* 2 6 */ {
...
void hal_iomux_set_uart0(void)
{
    ...
    hal_iomux_set_io_pull_select(HAL_IOMUX_PIN_P3_0, HAL_IOMUX_PIN_PULLUP_ENABLE);
...
void hal_iomux_set_uart1(void)
{
    ...
    hal_iomux_set_io_pull_select(HAL_IOMUX_PIN_P3_2, HAL_IOMUX_PIN_PULLUP_ENABLE);
...
void hal_iomux_set_analog_i2c(void)
{
    ...
    hal_iomux_set_io_voltage_domains(HAL_IOMUX_PIN_P3_1, HAL_IOMUX_PIN_VOLTAGE_VIO);
    hal_iomux_set_io_pull_select(HAL_IOMUX_PIN_P3_0, HAL_IOMUX_PIN_PULLUP_ENABLE);
    hal_iomux_set_io_pull_select(HAL_IOMUX_PIN_P3_1, HAL_IOMUX_PIN_PULLUP_ENABLE);
}
...
void hal_iomux_set_i2s0(void)
{
    ...
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_i2s[] = {
        ...
        {HAL_IOMUX_PIN_P1_0, HAL_IOMUX_FUNC_I2S0_WS,   I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_1, HAL_IOMUX_FUNC_I2S0_SDI0, I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_2, HAL_IOMUX_FUNC_I2S0_SDO,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_3, HAL_IOMUX_FUNC_I2S0_SCK,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#elif (I2S0_IOMUX_INDEX == 1)
        {HAL_IOMUX_PIN_P2_2, HAL_IOMUX_FUNC_I2S0_WS,   I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P2_3, HAL_IOMUX_FUNC_I2S0_SDI0, I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P2_4, HAL_IOMUX_FUNC_I2S0_SDO,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P2_5, HAL_IOMUX_FUNC_I2S0_SCK,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#else
        {HAL_IOMUX_PIN_P1_4, HAL_IOMUX_FUNC_I2S0_WS,   I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_5, HAL_IOMUX_FUNC_I2S0_SDI0, I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_6, HAL_IOMUX_FUNC_I2S0_SDO,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
        {HAL_IOMUX_PIN_P1_7, HAL_IOMUX_FUNC_I2S0_SCK,  I2S0_VOLTAGE_SEL, HAL_IOMUX_PIN_NOPULL},
#endif
    };
...
void hal_iomux_set_spdif0(void)
{
    static const struct HAL_IOMUX_PIN_FUNCTION_MAP pinmux_spdif[] = {
        ...
        {HAL_IOMUX_PIN_P1_1, HAL_IOMUX_FUNC_SPDIF0_DO, SPDIF0_VOLTAGE_SEL, HAL_IOMUX_PIN_PULLUP_ENABLE},
    };
