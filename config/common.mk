...
ifneq ($(filter 1,$(AMA_VOICE) $(DMA_VOICE) $(SMART_VOICE) $(TENCENT_VOICE) $(GMA_VOICE) $(CUSTOMIZE_VOICE)),)
export AI_VOICE := 1
endif
...
ifneq ($(findstring __VBUS_SUP_OLD__,$(KBUILD_CPPFLAGS)),)
	OTA_CODE_OFFSET := 0x28000
else
...
ifeq ($(PROJ_NAME), zt102)
ifneq ($(findstring __VBUS_SUP_OLD__,$(KBUILD_CPPFLAGS)),)
		KBUILD_CPPFLAGS += -DNEW_IMAGE_FLASH_OFFSET=0x1E8000
else
...
ifneq ($(filter 1,$(ALEXA_WWE) $(KWS_ALEXA)),)
...
ZOWEE_PARAMETER_SECTION_SIZE ?= 0x1000
...
export LDS_SECTION_FLAGS := \
	...
	-DZOWEE_PARAMETER_SECTION_SIZE=$(ZOWEE_PARAMETER_SECTION_SIZE)
...
# open for 2mic_ns2 by zhou 2021.03.04 end
# default:SPEECH_TX_MIC_CALIBRATION ?= 0
...
ifeq ($(SNDP_TX_3MIC_ENABLE),1)
KBUILD_CPPFLAGS += -DSNDP_TX_3MIC_ENABLE
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC
KBUILD_CPPFLAGS += -DSNDP_TX_3MIC_DUMP_ENABLE
#KBUILD_CPPFLAGS += -DSNDP_TX_3MIC_TIME_ENABLE
#KBUILD_CPPFLAGS += -DSNDP_TX_3MIC_BYPASS_ENABLE
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 3
...
# CCVUI configs	
#*********************************	
export CCVUI_1MIC_NS0 ?= 0	
ifeq ($(CCVUI_1MIC_NS0),1)	
KBUILD_CPPFLAGS += -DCCVUI_1MIC_NS0	
endif	
	
export CCVUI_1MIC_NS1 ?= 0	
ifeq ($(CCVUI_1MIC_NS1),1)	
KBUILD_CPPFLAGS += -DCCVUI_1MIC_NS1	
endif	
	
export CCVUI_1MIC_NS2 ?= 0	
ifeq ($(CCVUI_1MIC_NS2),1)	
KBUILD_CPPFLAGS += -DCCVUI_1MIC_NS2	
endif	
	
export CCVUI_2MIC_NS0 ?= 0	
ifeq ($(CCVUI_2MIC_NS0),1)	
KBUILD_CPPFLAGS += -DCCVUI_2MIC_NS0	
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC	
export SPEECH_PROCESS_FRAME_MS = 15	
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2	
endif	
	
export CCVUI_2MIC_NS1 ?= 0	
ifeq ($(CCVUI_2MIC_NS1),1)	
KBUILD_CPPFLAGS += -DCCVUI_2MIC_NS1	
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC	
export SPEECH_PROCESS_FRAME_MS = 15	
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2	
endif	
	
export CCVUI_2MIC_NS2 ?= 0	
ifeq ($(CCVUI_2MIC_NS2),1)	
KBUILD_CPPFLAGS += -DCCVUI_2MIC_NS2	
KBUILD_CPPFLAGS += -DHFP_DISABLE_NREC	
export SPEECH_PROCESS_FRAME_MS = 15	
export SPEECH_CODEC_CAPTURE_CHANNEL_NUM = 2	
endif	
...
# modify by kyle 20201213, _default_cfg_src_ => $(T)
#export DEFAULT_CFG_SRC ?= _default_cfg_src_
export DEFAULT_CFG_SRC ?= $(T)
